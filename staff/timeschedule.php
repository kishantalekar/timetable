...
// $que=mysqli_query($con,"select *  from timeschedule where teacher_id='30'");
	...
	echo "<td style='color:black'>".$res['department_name']."</td>" ;
	...
	echo "<td style='color:black'>".$res['subject_name']."</td>" ;
	...
	echo "<td style='color:black'>".$res['semester_name']."</td>" ;
